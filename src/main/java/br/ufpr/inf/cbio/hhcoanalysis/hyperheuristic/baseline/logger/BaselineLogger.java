 ...
 */
package br.ufpr.inf.cbio.hhcoanalysis.hyperheuristic.baseline.logger;
 ...
 */
public abstract class BaselineLogger implements Observer {

    protected final OutputWriter ow;

    public BaselineLogger(String folder, String file) {
    ...
    public abstract void update(Baseline hhco);
